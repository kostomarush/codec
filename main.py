...
class DeltaCodecApp(QMainWindow):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Работа со случайным сигналом:"))
        ...
        self.label_2.setText(_translate("MainWindow", "Введите уровень квантования для случайного сигнала:"))
        self.label_3.setText(_translate("MainWindow", "Введите количество отображаемого промежутка:"))
        self.generite.setText(_translate("MainWindow", "Генерация сигнала"))
        ...
        self.label_5.setText(_translate("MainWindow", "Введите уровень квантования для записанного сигнала:"))
        self.label_6.setText(_translate("MainWindow", "Введите количество отображаемого промежутка:"))
